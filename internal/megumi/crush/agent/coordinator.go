...
import (
	...
	"github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/agent/prompt"
	"github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/agent/tools"
	...
	"github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/filetracker"
	"github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/history"
	"github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/hooks"
	"github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/log"
	"github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/lsp"
	"github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/message"
	"github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/oauth/copilot"
...
func (c *coordinator) buildAnthropicProvider(baseURL, apiKey string, headers map[string]string, providerID string) (fantasy.Provider, error) {
	...
	// Megumi: when the embedding CLI registered a credential provider, inject
	// the live credential as x-api-key per request (so account tokens refresh
	// mid-session) instead of using a static config api_key.
	if CredentialProvider != nil {
		os.Setenv("ANTHROPIC_API_KEY", "")
		opts = append(opts, anthropic.WithAPIKey("megumi-managed")) // placeholder; transport overrides
		if len(headers) > 0 {
		...
		opts = append(opts, anthropic.WithHTTPClient(megumiCredentialClient()))
