...
This is the one-shot/print mode; ` + "`mgm megumi -p \"...\"`" + ` maps onto it.`,
	Example: `
# Run a simple prompt
mgm megumi -p "Guess my 5 favorite Pokémon"

# Pipe input from stdin
curl https://example.com | mgm megumi -p "Summarize this website"

# Redirect output to a file
mgm megumi -p "Generate a README for this project" > README.md

# Run in quiet mode (hide the spinner)
mgm megumi -p "Generate a README for this project" --quiet

# Continue a previous session
mgm megumi -p "Follow up on your last response" --session {session-id}

# Continue the most recent session
mgm megumi -p "Follow up on your last response" --continue
