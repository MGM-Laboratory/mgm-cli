...
import (
	...
	"github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/client"
	"github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/config"
	"github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/db"
	"github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/event"
	"github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/lock"
	crushlog "github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/log"
	"github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/projects"
	"github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/proto"
	"github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/server"
	...
	ui "github.com/MGM-Laboratory/mgm-cli/internal/megumi/crush/ui/model"
...
func init() {
	...
	rootCmd.PersistentFlags().StringP("data-dir", "D", "", "Custom Megumi data directory")
	rootCmd.PersistentFlags().BoolP("debug", "d", false, "Debug")
	rootCmd.PersistentFlags().StringVarP(&clientHost, "host", "H", server.DefaultHost(), "Connect to a specific Megumi server host (for advanced users)")
	rootCmd.Flags().BoolP("help", "h", false, "Help")
	// Persistent so the one-shot `run` subcommand honors it too (Megumi maps
	// --dangerously-skip-permissions onto --yolo, including for `mgm megumi -p`).
...
var rootCmd = &cobra.Command{
	Use:   "megumi",
	Short: "Megumi Code — the lab's terminal-first AI coding agent",
	Long:  "Megumi Code, the MGM Laboratory's terminal-first AI coding agent. Model requests are brokered through the lab backend; tools run locally.",
	Example: `
# Run in interactive mode
mgm megumi

# Run a single prompt non-interactively (one-shot / print mode)
mgm megumi -p "Guess my 5 favorite Pokémon"

# One-shot with pipes and redirection
cat README.md | mgm megumi -p "make this more glamorous" > GLAMOROUS_README.md

# Run with debug logging in a specific directory
mgm megumi --debug --cwd /path/to/project

# Skip all permission prompts (auto-accept; use with care)
mgm megumi --dangerously-skip-permissions

# Continue a previous session
mgm megumi --session {session-id}
  ...
  `,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if _, err := program.Run(); err != nil {
			...
			return errors.New("Megumi Code crashed. Please copy the stacktrace above and share it with the lab maintainers.") //nolint:staticcheck
		}
		return nil
	},
}
