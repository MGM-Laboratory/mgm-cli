...
const (
	...
	defaultInitializeAs  = "MEGUMI.md"
)

// defaultContextPaths is the Megumi Code memory-file convention: MEGUMI.md is
// primary (project + local), with CLAUDE.md / AGENTS.md retained for interop
// with repos already set up for other agents. Crush-branded names are dropped.
